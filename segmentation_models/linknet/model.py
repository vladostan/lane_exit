from .builder import build_linknet, build_linknet_notop, build_linknet_bottleneck, build_linknet_bottleneck_crop
...
@legacy_support(old_args_map)
def Linknet_notop(backbone_name='vgg16',
            input_shape=(None, None, 3),
            classes=1,
            activation='sigmoid',
    ...
    input, model = build_linknet_notop(backbone,
                          classes,
                          encoder_features,
                          decoder_filters=decoder_filters,
                          upsample_layer=decoder_block_type,
...
@legacy_support(old_args_map)
def Linknet_bottleneck(backbone_name='vgg16',
            input_shape=(None, None, 3),
            classes=1,
            activation='sigmoid',
            output_name = "segmentation_output",
    ...
    model = build_linknet_bottleneck(backbone,
                          classes,
                          encoder_features,
                          decoder_filters=decoder_filters,
                          upsample_layer=decoder_block_type,
...
@legacy_support(old_args_map)
def Linknet_bottleneck_crop(backbone_name='vgg16',
            input_shape=(None, None, 3),
            classes=1,
            activation='sigmoid',
            output_name = "segmentation_output",
    ...
    model = build_linknet_bottleneck_crop(backbone,
                          classes,
                          encoder_features,
                          decoder_filters=decoder_filters,
                          upsample_layer=decoder_block_type,
